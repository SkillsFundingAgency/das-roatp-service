...
namespace SFA.DAS.RoATPService.Ukrlp
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://ukrlp.co.uk.server.ws.v3", ConfigurationName="SFA.DAS.RoATPService.Ukrlp.ProviderQueryPortType")]
    internal interface ProviderQueryPortType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="retrieveAllProviders", ReplyAction="*")]
        [System.ServiceModel.FaultContractAttribute(typeof(SFA.DAS.RoATPService.Ukrlp.faultDetail), Action="retrieveAllProviders", Name="faultDetail")]
        ...
        System.Threading.Tasks.Task<SFA.DAS.RoATPService.Ukrlp.response> retrieveAllProvidersAsync(SFA.DAS.RoATPService.Ukrlp.ProviderQueryParam request);
    }
    ...
    internal partial class ProviderQueryParam
    {
        
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://ukrlp.co.uk.server.ws.v3", Order=0)]
        public SFA.DAS.RoATPService.Ukrlp.ProviderQueryStructure ProviderQueryRequest;
        
        public ProviderQueryParam()
        {
        }
        
        public ProviderQueryParam(SFA.DAS.RoATPService.Ukrlp.ProviderQueryStructure ProviderQueryRequest)
        {
    ...
    internal partial class response
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://ukrlp.co.uk.server.ws.v3", Order=0)]
        public SFA.DAS.RoATPService.Ukrlp.ProviderQueryResponse ProviderQueryResponse;
        
        public response()
        {
        }
        
        public response(SFA.DAS.RoATPService.Ukrlp.ProviderQueryResponse ProviderQueryResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    internal interface ProviderQueryPortTypeChannel : SFA.DAS.RoATPService.Ukrlp.ProviderQueryPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    internal partial class ProviderQueryPortTypeClient : System.ServiceModel.ClientBase<SFA.DAS.RoATPService.Ukrlp.ProviderQueryPortType>, SFA.DAS.RoATPService.Ukrlp.ProviderQueryPortType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<SFA.DAS.RoATPService.Ukrlp.response> SFA.DAS.RoATPService.Ukrlp.ProviderQueryPortType.retrieveAllProvidersAsync(SFA.DAS.RoATPService.Ukrlp.ProviderQueryParam request)
        {
            return base.Channel.retrieveAllProvidersAsync(request);
        }
        
        public System.Threading.Tasks.Task<SFA.DAS.RoATPService.Ukrlp.response> retrieveAllProvidersAsync(SFA.DAS.RoATPService.Ukrlp.ProviderQueryStructure ProviderQueryRequest)
        {
            SFA.DAS.RoATPService.Ukrlp.ProviderQueryParam inValue = new SFA.DAS.RoATPService.Ukrlp.ProviderQueryParam();
            inValue.ProviderQueryRequest = ProviderQueryRequest;
            return ((SFA.DAS.RoATPService.Ukrlp.ProviderQueryPortType)(this)).retrieveAllProvidersAsync(inValue);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.ProviderQueryPort))
            {
                return new System.ServiceModel.EndpointAddress("http://webservices.ukrlp.co.uk/UkrlpProviderQueryWS/ProviderQueryServiceV6");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }

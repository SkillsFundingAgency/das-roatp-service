...
public interface IOrganisationsRepository
{
    ...
    Task UpdateOrganisation(Entities.Organisation organisation, Audit audit, OrganisationStatusEvent statusEvent, bool removeNonStandardCourseTypes, string userId, CancellationToken cancellationToken);
}

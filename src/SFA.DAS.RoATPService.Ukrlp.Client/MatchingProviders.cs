...
public record MatchingProviders(IEnumerable<Provider> MatchingProviderRecords);
...
public record VerificationInfo(string VerificationAuthority, string VerificationId);
